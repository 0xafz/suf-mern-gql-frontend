...
const tagStyles = tw`inline-flex items-center bg-blue-200 bg-opacity-75 rounded-md text-blue-700 no-underline text-xs padding[.2em .5em] outline-color[darkblue] hover:bg-opacity-100`
